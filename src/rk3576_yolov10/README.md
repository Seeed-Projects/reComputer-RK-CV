# RK3576 YOLOv10 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a YOLOv10 object detection service optimized for RK3576. It provides RKNN inference, browser preview, REST APIs, offline video processing, and a ready-to-run Docker image.

## Core Features

- **Hardware Acceleration**: Runs YOLOv10 RKNN models on the RK3576 NPU through RKNN-Toolkit-Lite2.
...
- `web_detection.py` initializes the RK3576 NPU runtime, loops camera or video input, exposes FastAPI endpoints, and implements the official end-to-end, NMS-free two-stage Top-K post-processing.
...
1. Place an RK3576-compatible YOLOv10 `.rknn` model in `model/`.
