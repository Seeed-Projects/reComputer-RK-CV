# RK3576 MobileNetV2 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a MobileNetV2 image classification service optimized for RK3576. It provides an RKNN-based inference pipeline, browser preview, REST APIs, and a ready-to-run Docker image.
...
The default model is `model/rk3576_mobilenet_v2.rknn` and its input size is `224 x 224`.
