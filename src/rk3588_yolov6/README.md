# RK3588 YOLOv6 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a YOLOv6 object detection service optimized for RK3588. It provides RKNN inference, browser preview, REST APIs, offline video processing, and a ready-to-run Docker image.

## Core Features

- **Hardware Acceleration**: Runs YOLOv6 RKNN models on the RK3588 NPU through RKNN-Toolkit-Lite2.
...
- `web_detection.py` initializes the RK3588 NPU runtime, loops camera or video input, provides FastAPI endpoints, and implements YOLOv6-specific decoding and NMS.
...
1. Place an RK3588-compatible YOLOv6 `.rknn` model in `model/`.
