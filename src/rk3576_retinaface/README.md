# RK3576 RetinaFace Deployment Guide

[English] | [中文](./README_zh.md)

This directory packages RetinaFace face detection as a standard reComputer RK-CV service for RK3576. It provides RKNN NPU inference, five-point facial landmarks, browser preview, REST APIs, asynchronous MP4 processing, and an ARM64 Docker image.

## Core Features

- Runs the 320 × 320 MobileNet-backbone RetinaFace RKNN model on the RK3576 NPU.
...
Open `http://<BOARD_IP>:8000` for image upload and annotated preview or `http://<BOARD_IP>:8000/docs` for OpenAPI. If host port 8000 is occupied, use `-p 8001:8000`.
