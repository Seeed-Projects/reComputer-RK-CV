# RK3576 YOLOv7 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a YOLOv7 object detection service optimized for RK3576. It provides RKNN inference, browser preview, REST APIs, offline video processing, and a ready-to-run Docker image.

## Core Features

- **Hardware Acceleration**: Runs YOLOv7 RKNN models on the RK3576 NPU through RKNN-Toolkit-Lite2.
...
- `web_detection.py` initializes the RK3576 NPU runtime, loops camera or video input, provides FastAPI endpoints, and implements YOLOv7 anchor decoding and NMS.
...
1. Place an RK3576-compatible YOLOv7 `.rknn` model in `model/`.
