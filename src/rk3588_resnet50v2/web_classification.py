...
app = FastAPI(
    ...
    version="1.0.0",
    description="RK3588 ResNet50V2 image and video classification service",
)
...
def main():
    parser = argparse.ArgumentParser(description='Web ResNet50v2 classification on RK3588')
    parser.add_argument(
        '--model_path',
        type=str,
        default=str(BASE_DIR / 'model' / 'rk3588_resnet50-v2-7.rknn'),
