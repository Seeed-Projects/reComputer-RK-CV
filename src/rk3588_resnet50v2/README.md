# RK3588 ResNet50V2 Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a ResNet50V2 image classification service optimized for RK3588. It provides an RKNN-based inference pipeline, browser preview, REST APIs, and a ready-to-run Docker image.
...
The default model is `model/rk3588_resnet50-v2-7.rknn` and its input size is `224 x 224`.
