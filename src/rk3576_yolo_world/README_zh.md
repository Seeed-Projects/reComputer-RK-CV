# RK3576 YOLO-World 部署指南

[English](./README.md) | [中文]

本目录提供面向 RK3576 的标准化 YOLO-World 部署：RKNN NPU 推理、浏览器预览、REST API 和 Docker 一键运行。

## 核心特性

- **NPU 加速**：通过 RKNN Toolkit Lite2 在 RK3576 NPU 上运行 YOLO-World RKNN 模型。
