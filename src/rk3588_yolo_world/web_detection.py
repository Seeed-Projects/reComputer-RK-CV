...
# --- FastAPI 核心组件 ---
app = FastAPI(
    title="reComputer RK-CV YOLO-World API",
    version="1.0.0",
    description="RK3588/RK3576 YOLO-World object detection service",
)
...
async def index():
    ...
    if is_web_only:
        ...
        <html>
          <head>
            <title>reComputer RK-CV YOLO-World Web Analytics</title>
            <style>
          ...
          <body>
            <div class="container">
              <h1>YOLO-World Offline Video Analytics</h1>
    ...
    <html>
      <head>
        <title>reComputer RK-CV Real-time YOLO-World Detection</title>
        <style>
          body { background-color: #1a1a1a; color: white; text-align: center; font-family: sans-serif; margin: 0; padding: 20px; }
      ...
      <body>
        <div class="container">
          <h1>YOLO-World Real-time Detection</h1>
