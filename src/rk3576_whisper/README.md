# RK3576 Whisper Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains OpenAI's Whisper ASR (Automatic Speech Recognition) inference code optimized for RK3576.

## Core Features
- **Hardware Acceleration**: Full utilization of RK3576's 6 TOPS NPU computing power for audio transcription.
...
- `model/`: Stores `.rknn` encoder and decoder models converted for RK3576 (e.g., `whisper_encoder_base_20s.rknn`, `whisper_decoder_base_20s.rknn`).
