# RK3576 Whisper 语音识别与 Web 接口项目

该项目基于 RKNN-Toolkit-Lite2，在瑞芯微 RK3576 平台上实现 OpenAI Whisper 语音识别模型的高性能部署。项目采用纯 Python 架构，集成了 FastAPI 提供 Web API 和简单易用的网页端 UI 界面。
...
### 1. 硬件要求
- 瑞芯微 RK3576 开发板 (例如: reComputer RK-CV 系列)
...
- 项目利用了 RK3576 的多个 NPU 核心。默认逻辑中将 Encoder 与 Decoder 分配至不同的核心以优化负载。
