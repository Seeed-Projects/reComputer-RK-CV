# RK3576 ResNet50V2 部署指南

[English](./README.md) | [中文]

本目录包含针对 RK3576 优化的 ResNet50V2 图像分类服务，提供基于 RKNN 的推理流程、浏览器预览、REST API，以及可直接运行的 Docker 镜像。
...
默认模型为 `model/rk3576_resnet50-v2-7.rknn`，输入尺寸为 `224 x 224`。
