...
This project packages DeepLabV3 semantic segmentation for RK3588 with RKNN NPU inference, live camera/local-video preview, browser-uploaded MP4 analysis, REST APIs, and Docker deployment.
