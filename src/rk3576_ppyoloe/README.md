# RK3576 PP-YOLOE Deployment Guide

[English] | [中文](./README_zh.md)

This directory provides a standardized PP-YOLOE deployment for RK3576: RKNN NPU inference, browser preview, REST API, and one-command Docker startup.

## Core Features

- **NPU acceleration**: Runs the PP-YOLOE RKNN model on the RK3576 NPU through RKNN Toolkit Lite2.
