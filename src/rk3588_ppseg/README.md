# RK3588 PPSeg Deployment Guide

[English] | [中文](./README_zh.md)

This directory packages the official PP-LiteSeg Cityscapes example as a standard reComputer RK-CV service for RK3588. It provides RKNN NPU inference, browser preview, REST APIs, asynchronous MP4 processing, and an ARM64 Docker image.

## Core Features

- Runs `ppseg.rknn` with RKNN-Toolkit-Lite2 on the RK3588 NPU.
...
- `model/`: RK3588 RKNN model and the warm-up image `test.png`.
...
Open `http://<BOARD_IP>:8000` for the preview page or `http://<BOARD_IP>:8000/docs` for OpenAPI. If host port 8000 is occupied, use `-p 8001:8000`.
