# RK3588 YOLOX Deployment Guide

[English] | [中文](./README_zh.md)

This directory contains a YOLOX object detection service optimized for RK3588. It provides RKNN inference, browser preview, REST APIs, offline video processing, and a ready-to-run Docker image.

## Core Features

- **Hardware Acceleration**: Runs YOLOX RKNN models on the RK3588 NPU through RKNN-Toolkit-Lite2.
...
- `web_detection.py` initializes the RK3588 NPU runtime, loops camera or video input, exposes FastAPI endpoints, and implements YOLOX branch decoding, objectness/class score fusion, and class-aware NMS.
...
1. Place an RK3588-compatible YOLOX `.rknn` model in `model/`.
