# RK3576 MMS-TTS Deployment Guide

[English] | [中文](./README_zh.md)

English speech synthesis using `facebook/mms-tts-eng` encoder and decoder models converted for the RK3576 NPU.
...
sudo docker run --rm --privileged --net=host \
    ...
    ghcr.io/seeed-projects/recomputer-rk-cv/rk3576-mms_tts:latest
```
