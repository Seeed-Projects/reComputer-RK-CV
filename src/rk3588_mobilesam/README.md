# RK3588 MobileSAM Deployment Guide

[English] | [中文](./README_zh.md)

This directory packages Mobile Segment Anything (MobileSAM) as a standard reComputer RK-CV service for RK3588. The encoder and prompt decoder run as RKNN models, while the browser preview and REST API expose prompt-based image segmentation and asynchronous MP4 processing.

## Core Features

- Runs the MobileSAM encoder and decoder on the RK3588 NPU with RKNN-Toolkit-Lite2.
