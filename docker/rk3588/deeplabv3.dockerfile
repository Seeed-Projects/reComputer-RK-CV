...
CMD ["python3", "web_service.py", "--platform", "rk3588", "--model_path", "/app/model/deeplabv3.rknn", "--sample_path", "/app/model/test.jpg", "--overlay_alpha", "0.5", "--camera_id", "-1", "--host", "0.0.0.0", "--port", "8000"]
